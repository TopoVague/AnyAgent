...
public class SearchFunctions {
	public static HashMap<String, Double> runHillClimbing(HashMap<String, NameToVariableClass> systemVariables, HashMap<String, NameToVariableClass> geoGenerationVariables){
			...
			if (takeAnotherStep){
				...
				for (String key: variablesToStep ) { //Iterate through each variable
					...
					for (int j = -1; j < 2; j+=2){ //iterating positive and negative getting -1 and 1
						...
						AgentPanel12_GUI_Alan.addMessage("\tRetieved value: " + retrievedValue);
